...
class GroupChat(models.Model):
    ...
    title = models.CharField(verbose_name='Name',null=True,max_length=50,validators=[alphanumeric_validator])
...
class JobsTable(models.Model):
    location = models.CharField(null=True,blank=True,max_length=80)
    OpenedDate = models.CharField(null=True,blank=True,max_length=500)
    Details =  models.JSONField(blank=True,null=True) 
